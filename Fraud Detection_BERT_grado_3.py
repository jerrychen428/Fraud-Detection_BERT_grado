...
data = {
    "text": [
        "警示：偵測到帳戶轉出 $5000。",          # 中文詐騙
        "Regular transaction of $200 at Walmart.",  # 英文正常
        "⚠️ 發現使用信用卡 5678 有異常交易。",   # 中文詐騙
        "付款至海外帳戶 $1500",                    # 中文詐騙
        "正常交易：全聯消費 $50。",                # 中文正常
        "Your payment to Apple of $9.99 was successful.",  # 英文正常
        "Suspicious transfer of $5000 detected from account 1234.",
        "Regular transaction of $200 at Walmart.",
        "Fraudulent activity detected with credit card 5678.",
        "Payment of $1500 sent to offshore account.",
...
# Tokenizer
tokenizer = BertTokenizer.from_pretrained("hfl/chinese-roberta-wwm-ext") # 原模型bert-base-uncased
...
# 模型
model = BertForSequenceClassification.from_pretrained("hfl/chinese-roberta-wwm-ext", num_labels=2) # 原模型bert-base-uncased
